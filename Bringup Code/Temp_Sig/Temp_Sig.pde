...
void setup(){
  ...
  mySerial.print(txbuffer);
   ...
   if (!sensors.getAddress(insideThermometer, 0)) mySerial.print("Unable to find address for Device 0\n"); 
  if (!sensors.getAddress(outsideThermometer, 1)) mySerial.print("Unable to find address for Device 1\n"); 
}

void loop(){
    mySerial.print("Sensor 0: {");
